...
select * from [STUDENT PERFORMANCE1]

-- 1. What is the distribution of students by gender?

select Gender, count(*) as Student_Count from [STUDENT PERFORMANCE1]
group by Gender;
...
avg(Writing_Score) as avg_writing from [STUDENT PERFORMANCE1]
...
select Gender, 
avg(Average) as Overall_Average_Score from [STUDENT PERFORMANCE1]
group by Gender;
